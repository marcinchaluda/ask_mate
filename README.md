...
**Git:**
- :exclamation: [Working with the `git remote` command](https://git-scm.com/docs/git-remote)
- :open_book: [Merge vs rebase](https://learn.code.cool/full-stack/#/../pages/git/merge-vs-rebase)
- :open_book: [Mastering git](https://learn.code.cool/full-stack/#/../pages/git/mastering-git)
...
**Workflow:**
- :exclamation: [Gitflow workflow](https://learn.code.cool/full-stack/#/../pages/git/git-branching)
...
- :open_book: [HTTP is stateless](https://learn.code.cool/full-stack/#/../pages/web/authentication-http-stateless)
...
- :open_book: [Collection of web resources](https://learn.code.cool/full-stack/#/../pages/web/resources.md)
